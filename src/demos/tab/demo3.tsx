...
const Demo1 = () => {
  ...
  return (
    <div>
      <p style={{ margin: '28px 0px 16px 16px' }}>标签栏风格为task</p>
      <Tab>
        <Tab.Item key="标签1" title="标签1" taskNum={22} taskWeight={2}>{content}</Tab.Item>
        <Tab.Item key="标签2" title="标签2" taskNum={42} taskWeight={2}>{content}</Tab.Item>
        <Tab.Item key="标签3" title="标签3" taskNum={129} dot>{content}</Tab.Item>
        <Tab.Item key="标签4" title="标签4" taskNum={37}>{content}</Tab.Item>
      </Tab>
    </div>
  );
};
